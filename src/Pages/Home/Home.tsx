    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center w-4/6 text-center gap-7 dark:text-white ">
                ...
                <IoIosPhoneLandscape className="size-28 md:size-0 lg:size-0 animate__animated animate__rotateInDownRight animate__slower animate__infinite animate__delay-1s"></IoIosPhoneLandscape>
            </div>
        </>
    )
}
